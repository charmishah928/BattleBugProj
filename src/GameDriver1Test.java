...
public class GameDriver1Test
{
    ...
    public static void main(String[] args)
    {
        ...
        battleBugs.add(new CShahBug(0,0,5,"CShahBug",Color.PINK));
	battleBugs.add(new CShahBug(2,2,1, "CShahBug2", Color.BLUE));
	battleBugs.add(new CShahBug(0,4,1, "CShahBug3", Color.CYAN));
	battleBugs.add(new CShahBug(0,5,0, "CShahBug4", Color.RED));
